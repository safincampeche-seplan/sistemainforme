...
async function main() {
    ...
    const sectorData = importCSV('cat_sectors.csv');
    ...
    const missionData = importCSV('cat_missions.csv');
    ...
    const depData = importCSV('cat_dependencies.csv');
    let count = 0;
...
//# sourceMappingURL=import_master_catalogs.js.map