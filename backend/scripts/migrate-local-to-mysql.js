...
function periodToNarrativePeriodId(year) {
...
async function main() {
    ...
    for (const filePath of files) {
        ...
        const narratives = localData.narratives || [];
        ...
        for (const n of narratives) {
            ...
            try {
                ...
                const existing = await prisma.narrativeCapture.findFirst({
                    where: {
                        ppa_name: n.ppa_name,
                        dependency_id: depId,
...
//# sourceMappingURL=migrate-local-to-mysql.js.map