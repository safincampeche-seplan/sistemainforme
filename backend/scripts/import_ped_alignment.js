...
async function main() {
    ...
    for (const sheetName of workbook.SheetNames) {
        ...
        for (const row of data) {
            const { id_mision, id_objetivo, nom_objetivo, id_estrategia, nom_estrategia, id_linea, nom_linea } = row;
            if (!id_mision || !id_objetivo)
                continue;
            // 1. Objetivo
...
//# sourceMappingURL=import_ped_alignment.js.map